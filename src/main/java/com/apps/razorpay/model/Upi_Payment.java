...
@Entity(name = "Upi_Payment")
@Table(name = "\"Upi_Payment\"", schema =  "\"razorpay\"")
@Data
...
public class Upi_Payment {
  ...
  @Column(name = "\"Upi\"")
  @AttributeOverrides({
            	@AttributeOverride(name = "payer_account_type", column = @Column(name = "\"Upi_Payer_account_type\"")) ,
            	@AttributeOverride(name = "vpa", column = @Column(name = "\"Upi_Vpa\"")) ,
            	@AttributeOverride(name = "flow", column = @Column(name = "\"Upi_Flow\""))  }) 
  private Upi upi;
